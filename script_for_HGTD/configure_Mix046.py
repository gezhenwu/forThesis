#python3 configure_Mix046.py --dacChargeMax 100 --pixelOn all --pixelInj col0 --smallCtest -F ./config/altiroc/Mix046.yaml -d 0 -G 1 --elinkFile ./config/felix/fourModule.yelc
...
for modules in alti_dict["Modules"]:
    ...
    for chips in modules["chips"]:
        ...
        alti = altiroc3_Mix046.Altiroc(devnr = devnr, gbt = gbt, addr = timing_addr, use_usb = False, module_id = module_nb, chip_id = chip_nb)
