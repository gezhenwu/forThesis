...
=======
    enable_timing, speed_timing = sync.module_on(options.gbt)
    enable_lumi, speed_lumi = sync.module_on(options.gbt+9)
>>>>>>> 4cf58c88179a9dbfdf086443337f5e5358a75ba2

    print("-----------Timing lpGBT setup-------------")
    peb.module_setup(module_id = 0, enable = enable_timing[0], eprx_data_rate = speed_timing[0])
    peb.module_setup(module_id = 1, enable = enable_timing[1], eprx_data_rate = speed_timing[0])
    peb.module_setup(module_id = 2, enable = enable_timing[2], eprx_data_rate = speed_timing[0])
    peb.module_setup(module_id = 3, enable = enable_timing[3], eprx_data_rate = speed_timing[0])
    peb.module_setup(module_id = 4, enable = enable_timing[4], eprx_data_rate = speed_timing[1])
    peb.module_setup(module_id = 5, enable = enable_timing[5], eprx_data_rate = speed_timing[1])
    peb.module_setup(module_id = 6, enable = enable_timing[6], eprx_data_rate = speed_timing[1])
    peb.module_setup(module_id = 7, enable = enable_timing[7], eprx_data_rate = speed_timing[1])
    peb.module_setup(module_id = 8, enable = enable_timing[8], eprx_data_rate = speed_timing[2])
    peb.module_setup(module_id = 9, enable = enable_timing[9], eprx_data_rate = speed_timing[2])
    peb.module_setup(module_id = 10, enable = enable_timing[10], eprx_data_rate = speed_timing[2])
    peb.module_setup(module_id = 11, enable = enable_timing[11], eprx_data_rate = speed_timing[2])
    peb.module_setup(module_id = 12, enable = enable_timing[12], eprx_data_rate = speed_timing[3])
    peb.module_setup(module_id = 13, enable = enable_timing[13], eprx_data_rate = speed_timing[3])
