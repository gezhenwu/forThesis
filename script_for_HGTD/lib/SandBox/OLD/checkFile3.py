...
parser.add_argument('-p','--pixel', type=int, help='the channel number to filter',default=127)
...
#file_pattern = "Data3/B_1_2023_09_29_IB7/delayScan_ExtDiscri_True/B_1_On_all_Inj_col_N_100_Vth_0_cDel_0_fDel_9/pixelOn_all_pixelInj_col0/timing_data_cdelay_*csv"
